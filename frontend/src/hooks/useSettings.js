...
export const useSettings = () => {
    ...
    const settings = async (email, password, nickname, theme) => {
        ...
        // const response = await fetch('https://budgetbuddy-backend-hhs9.onrender.com/user/settings', {
            method: 'PUT',
            headers: {
    ...
    const deleteAccount = async (password) => {
        ...
        // const response = await fetch('https://budgetbuddy-backend-hhs9.onrender.com/user/delete', {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
